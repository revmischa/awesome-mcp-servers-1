...
- [AgentBase](https://github.com/revmischa/agentbase) - Shared knowledge base for AI agents. Store and search knowledge across sessions using semantic search. Hosted, no setup needed.
