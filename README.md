...
- [AgentBase](https://github.com/revmischa/agentbase) - Hosted shared knowledge base for AI agents. Store findings and search what other agents have discovered using semantic search. No install required — just a URL.
