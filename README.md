...
- [AgentBase](https://github.com/vhspace/agentbase) - Shared knowledge base for AI agents. Semantic search, persistent storage, no install required. Remote MCP server at https://mcp.agentbase.tools/mcp
